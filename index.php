...
<head>
	...
	<title>Bethel Jobs - Job Portal</title>
    ...
    <meta property="og:image:alt" content="Bethel Jobs" />
...
<body class="home">
    ...
    <ul class="nav navbar-nav" id="responsive-menu">
		...
		<li>
								<a href="job-list.php" style="text-transform: uppercase;"> Job List</a>

		</li>
<li>
								<a href="employers.php" style="text-transform: uppercase;">Companies</a>
							</li>
<li>
								<a href="contact.php" style="text-transform: uppercase;">Contact Us</a>
							</li> 
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/02.jpg');">
				<div class="container">
					...
					<h1>Take Step To Your Dream Success</h1>
					<p>Find your job on Bethel Jobs</p>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Bethel Jobs</h5>
											<p>Bethel Jobs is a job portal, online job management system developed by Group-2 Students for a final project in 2024.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Bethel Jobs Contact</h5>
								
								<p>Address : Addis Ababa, Ethiopia</p>
								<p>Email : <a href="mailto:Betheljobs@gmail.com">Betheljobs@gmail.com</a></p>
								<p>Phone : <a href="tel:+25112121212">+25112121212</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Bethel Jobs</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Salale University Students</a></li>
								</ul>
